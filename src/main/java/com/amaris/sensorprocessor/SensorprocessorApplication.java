...
//				"device_005", LocalDateTime.now().toString(), true, "Batiment D",
...
//				"device_002", LocalDateTime.now().plusYears(10).toString(), false,
...
//				"user24", "Toto", "Dupond", "$2a$10$sS1tlLqD2vrQahfdHBKGKeGNeq7oPUSnWk8bEt/uQt4jt0Cyk3Xi2", "USER",
//				"toto.dupond@example.com")) + "\u001B[0m");
//		System.out.println("\u001B[34m" + "update 2 -> " + userDao.updateUser(new User(
//				"user23", "Jannette", "Smith", "$2a$10$sS1tlLqD2vrQahfdHBKGKeGNeq7oPUSnWk8bEt/uQt4jt0Cyk3Xi2", "boss final",
...
//				LocalDateTime.now().toString(),true, "Batiment E", 2, "Bureau 505")) + "\u001B[0m");
//		System.out.println("\u001B[34m" + "update gateway_022 -> " + gatewayDao.updateGateway(new Gateway("gateway_002",
//				LocalDateTime.now().toString(), false, "Batiment Z", 8, "Bureau 725")) + "\u001B[0m");
